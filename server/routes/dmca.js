...
router.get("/", async (req, res) => { // route that site manager can use to get the dmca policy
...
router.post("/", async (req, res) => { // route that site manager can use to update the dmca policy
        
        
        const dmcaPolicyInformation = sanitizeHtml(req.body.dmca_policy_information); // policy information from the dmca policy table
...
router.put("/", async (req, res) => { // route that site manager can use to create a new dmca policy
