...
router.post(
    ...
    async (req, res) => {
        ...
        const isPublicResponse = await pool.query(
        ...
        await pool.query(
            "UPDATE playlists SET average_rating = $1 WHERE playlist_id = $2",
            [updateAvgRatingResponse.rows[0].avg_review, req.params.playlist_id]
        );
