...
router.get("/", async (req, res) => {
    // route that site manager can use to get the aup policy
...
router.post("/", async (req, res) => {
    // route that site manager can use to update the aup policy
...
router.put("/", async (req, res) => {
    // route that site manager can use to create a new aup policy
