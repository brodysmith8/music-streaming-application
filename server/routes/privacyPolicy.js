...
router.get("/", async (req, res) => {
    // route that site manager can use to get the privacy policy
...
router.post("/", async (req, res) => {
    // route that site manager can use to update the privacy policy
...
router.put("/", async (req, res) => {
    // route that site manager can use to create a new privacy policy
