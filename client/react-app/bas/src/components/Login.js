        ...
        <div className='loginBG flex h-screen'>
             ...
             <div className="w-full max-w-xs m-auto">
                <div className = 'applicationName'>
                    <div className = 'text-5xl font-bold text-white text-center absolute inset-y-20 inset-x-50'>
                        BAS MUSIC APP
                    </div>
                
                <div className = 'aboutApplication'>
                    <div className = "bg-red-200 bg-opacity-20 backdrop-blur-sm rounded drop-shadow-lg px-5 pt-6 pb-8 mb-6">
